...
// .wrangler/tmp/bundle-xj08Uf/strip-cf-connecting-ip-header.js
...
function processTableBlock(block) {
  ...
  html2 += "</table>";
  console.log("processTableBlock output type:", typeof html2, "value:", html2);
  return html2;
}
...
function wikitextToHtml(wt) {
  ...
  console.log("wikitextToHtml after table replacement type:", typeof s, "value:", s);
  return s;
}
...
// .wrangler/tmp/bundle-xj08Uf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xj08Uf/middleware-loader.entry.ts

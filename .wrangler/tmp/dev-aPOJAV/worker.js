...
// .wrangler/tmp/bundle-ZmB1Xw/strip-cf-connecting-ip-header.js
...
var worker_default = {
  ...
  async fetch(req, env) {
    ...
    if (path.startsWith("/posts/")) {
      ...
      const body = await renderPost(env, slug, content);
      return html(body);
    }
...
function wikitextToHtml(wt) {
  ...
  s = s.replace(/^(?!<h\d>|<p|<a|<strong>|<em>|<code>|<u>|<s>|<pre>)/gm, "<p>$&</p>");
  return s;
}
...
async function renderPost(env, slug, contentHtml) {
...
// .wrangler/tmp/bundle-ZmB1Xw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZmB1Xw/middleware-loader.entry.ts
